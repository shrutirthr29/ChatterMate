...
function Container({data}) {
  ...
  return (
  <div className="border-conversation-border border-l w-full bg-panelbackground flex flex-col h-[100vh] overflow-hidden items-center justify-center text-black">
